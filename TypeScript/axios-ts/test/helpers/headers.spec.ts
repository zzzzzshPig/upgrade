import { transformResponseHeader, processHeaders, flattenHeaders } from '../../src/helpers/header'

describe('helpers:header', () => {
    describe('transformResponseHeader', () => {
        test('should parse headers', () => {
            const parsed = transformResponseHeader(
        ...
        test('should return empty object if headers is empty string', () => {
            expect(transformResponseHeader('')).toEqual({})
        })
    })
